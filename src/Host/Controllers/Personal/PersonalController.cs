using Architech.WebApi.Application.Auditing;
using Architech.WebApi.Application.Identity.Users;
using Architech.WebApi.Application.Identity.Users.Password;
using Architech.WebApi.Host.Controllers;

namespace Architech.WebApi.Host.Controllers.Personal;
